<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link <?= ($tab=='mysql') ? 'active':'' ?>" aria-current="page" href="/admin/share/server?setting=database&tab=mysql&act=index&webid=<?=$webid?>" onclick="loading()">MySQL（5.7）</a>
    </li>
    <li class="nav-item">

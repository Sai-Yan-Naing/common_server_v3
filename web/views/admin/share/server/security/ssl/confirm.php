...
if($action =='new')
{
	...
	$msgsession ="msg";
	$reg_date =  Date('Y/m/d');
	$reg_date = date('Y-m-d', strtotime("+3 months", strtotime($reg_date)));
	$temp1["ssl"] = ['common_name'=>$common_name,'prefecture'=>$prefecture,'municipality'=>$municipality,'organization'=>$organization,'regdate'=>$reg_date];

<?php require_once("views/admin/admin_shareconfig.php"); ?>
    <div class="modal-header">
        <button type="button" class="btn btn-outline-info mr-3" form="web_config_fm" id="web_config_btn" gourl="/admin/share/server?setting=site&tab=app_setting&act=confirm&apply=web.config&webid=<?=$webid?>">Save</button>

                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading"><a class="text-white" href="/admin/share/server?setting=site&tab=app_install&act=index&webid=<?=$webid?>" onclick="loading()"><h3><span style="font-size:50px;">W</span>inserver</h3></a></div>
                            ...
                            <a class="nav-link active" href="/admin/share/server?setting=site&tab=app_install&act=index&webid=<?=$webid?>" onclick="loading">
                            ...
                            <a class="nav-link active" href="/admin/share/mail?setting=email&tab=tab&act=index&webid=<?=$webid?>" onclick="loading()">
                            ...
                            <a class="nav-link active" href="/admin/share/various?setting=information&act=index&webid=<?=$webid?>" onclick="loading()">

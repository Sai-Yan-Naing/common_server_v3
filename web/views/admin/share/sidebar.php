                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading"><a class="text-white" href="/admin/share/server?setting=site&tab=app_install&act=index&webid=<?=$webid?>"><h3><span style="font-size:50px;">W</span>inserver</h3></a></div>

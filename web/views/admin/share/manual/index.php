                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="shadow-lg p-3 mb-5 bg-white rounded">
                                ...
                                <div class="tab-content">
                                    <ul class="manual">
                                        <li><a href="#setting1" class="msetting"><span class="mr-2">1.</span> 共用コントロールパネル</a></li>
                                    ...
                                    <div id="setting3" class="cmanual">
                                        ...
                                        <h3>パスワード</h3>
                                        <p>アプリケーションのパスワードを8～32文字で入力してください。</p>
                                        <p>半角英数字記号のみ利用可能です。</p>
                                        <h2>データベース</h2>
                                        ...
                                        <h3>パスワード</h3>
                                        <p>データベースのパスワードを8～70文字で入力してください。</p>
                                    </div>

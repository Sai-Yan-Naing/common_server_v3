                                    ...
                                    <div class="active">
                                        <div class="row mt-3 mb-3">
                                            ...
                                            <div class="col-sm-9 d-flex">
                                                ...
                                                <button class="btn btn-info btn-sm common_dialog ml-2" gourl="/admin/share/mail?setting=email&tab=tab&act=import&webid=<?= $webid?>" data-toggle="modal" data-target="#common_dialog"><span class="mr-2"><i class="fas fa-plus-square"></i></span>Import from CSV</button>
                                            </div>
                                            <?php endif; ?>
                                        </div>

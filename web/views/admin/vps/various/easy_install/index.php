                        ...
                        <div class="tab-content">
                            <div id="page-body" class="tab-pane active pr-3 pl-3"><br>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <a class="btn btn-outline-info btn-lg my-2" href="/admin/vps/various?setting=easy_install&tab=easy_install&act=confirm&action=iisinstall&webid=<?=$webid?>" onclick="loading()">IISインストール</a>
                                    </div>
                                </div> 
                                <div class="mb-4">

            ...
            <main class="main-page">
                    <div class="container-fluid px-4">
                            ...
                            <div class="shadow-lg p-3 mb-5 bg-white rounded">
                                ...
                                <form action="/vps/easy_install/confirm?server=vps&setting=various&tab=easy_install&action=new" id="sql_2016" method="post">
                                    <input type="hidden" value="2016">
                                </form>
                                <form action="/vps/easy_install/confirm?server=vps&setting=various&tab=easy_install&action=new" id="sql_2017" method="post">
                                    <input type="hidden" value="2017">
                                </form>
                                <form action="/vps/easy_install/confirm?server=vps&setting=various&tab=easy_install&action=new" id="sql_2019" method="post">

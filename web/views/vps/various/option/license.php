                    ...
                    <div class="container-fluid px-4">
                            ...
                            ?>
                                <div class="tab-content">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="sql_server_edition">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="remote_desktop_license">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="office_license">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="window_server_license">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="site_guard_license">
                                    ...
                                    <form onsubmit="loading()" action="/vps/various?setting=option&tab=license&act=license_confirm&webid=<?=$webid?>" method="post" id="ssl_license">

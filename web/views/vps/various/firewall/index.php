                                ...
                                <div class="contract">
                                    <div class="server-info">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_rdp&webid=<?=$webid?>" id="change_rdp" method="post">
                                            ...
                                            <div class="col-sm-2">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_rdp&webid=<?=$webid?>" id="change_rdpd" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_rdip&webid=<?=$webid?>" id="change_rdip" method="post">
                                            ...
                                            <div class="col-sm-2">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_rdip&webid=<?=$webid?>" id="change_rdipd" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_httprdp&webid=<?=$webid?>" id="change_httprdp" method="post">
                                                <input type="text" required class="form-control" name="port">
                                            </form>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_httprdp&webid=<?=$webid?>" id="change_httprdpd" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_httprdip&webid=<?=$webid?>" id="change_httprdip" method="post">
                                                <input type="text" required class="form-control" name="ip">
                                            </form>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-2">
                                            <form onsubmit="loading()" action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=change_httprdip&webid=<?=$webid?>" id="change_httprdipd" method="post">
                                                <input type="hidden" class="form-control" name="ip" value="any">
                                            </form>
            ...
            <div id="layoutSidenav_content">
                <main class="main-page">
                        <div class="container-fluid px-4">
                                ...
                                <?php require_once('views/vps/various/subtitle.php') ?>
                                <div class="shadow-lg p-3 mb-5 bg-white rounded">
                                    <div class="contract" id='terminal' style="height: 500px;" gourl="/vps/various?setting=firewall&tab=firewall&act=terminal&webid=<?=$webid?>">

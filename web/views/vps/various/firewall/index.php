                        ...
                        <div class="server-info">
                            ...
                            <div class="form-group row ml-1">
                                ...
                                <div class="col-sm-2 d-flex align-items-center justify-content-center">
                                    <button class="btn btn-sm btn-outline-info vpsrebtn common_dialog" type="button"
                                        ...
                                        gourl="/vps/various?setting=firewall&tab=firewall&act=new_port&action=remote_desktop_port&webid=<?=$webid?>">変更</button>
                                </div>
                                <?php if ($rdp->port !== '3389'): ?>
                                <div class="col-sm-3 d-flex align-items-center justify-content-center">
                                    <form
                                        action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=remote_desktop_port&webid=<?=$webid?>"
                            ...
                            <div class="form-group row ml-1">
                                ...
                                <div class="col-sm-2 d-flex align-items-center justify-content-center">
                                    <button class="btn btn-sm btn-outline-info vpsrebtn common_dialog" type="button"
                                        data-toggle="modal" data-target="#common_dialog"
                                        gourl="/vps/various?setting=firewall&tab=firewall&act=new_ip_restriction&action=remote_desktop_ip&webid=<?=$webid?>">変更</button>
                                </div>
                                <?php if ($rdp->ip !== 'any'): ?>
                                <div class="col-sm-3 d-flex align-items-center justify-content-center">
                                    <form
                                        action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=remote_desktop_ip&webid=<?=$webid?>"
                            ...
                            <div class="form-group row ml-1">
                                ...
                                <div class="col-sm-2 d-flex align-items-center justify-content-center">
                                    <button class="btn btn-sm btn-outline-info vpsrebtn common_dialog" type="button"
                                        data-toggle="modal" data-target="#common_dialog"
                                        gourl="/vps/various?setting=firewall&tab=firewall&act=new_port&action=web_access_port&webid=<?=$webid?>">変更</button>
                                </div>
                                <?php if ($web_rdp->port !== '80'): ?>
                                <div class="col-sm-3 d-flex align-items-center justify-content-center">
                                    <form
                                        action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=web_access_port&webid=<?=$webid?>"
                            ...
                            <div class="form-group row ml-1">
                                ...
                                <div class="col-sm-2 d-flex align-items-center justify-content-center">
                                    <button class="btn btn-sm btn-outline-info vpsrebtn common_dialog" type="button"
                                        data-toggle="modal" data-target="#common_dialog"
                                        gourl="/vps/various?setting=firewall&tab=firewall&act=new_ip_restriction&action=web_access_ip&webid=<?=$webid?>">変更</button>
                                </div>
                                <?php if ($web_rdp->ip !== 'any'): ?>
                                <div class="col-sm-3 d-flex align-items-center justify-content-center">
                                    <form
                                        action="/vps/various?setting=firewall&tab=firewall&act=confirm&action=web_access_ip&webid=<?=$webid?>"
...
<div id="layoutSidenav">
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        socket = io.connect('https://terminal.winserver.ne.jp/', {query:{ host: '202.218.224.149',username:'administrator',password:'bmbivPanKuQ5AVe' }});
            ...
            <div class="container-fluid px-4">
                ...
                <div class="shadow-lg p-3 mb-5 bg-white rounded">
                    <div class="contract" id='terminal-container' style="height: 500px;"
                        gourl="/vps/various?setting=firewall&tab=firewall&act=terminal&webid=<?=$webid?>">

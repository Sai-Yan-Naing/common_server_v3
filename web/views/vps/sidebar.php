                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="/vps/server?tab=connection&act=index">
                            ...
                            <a class="nav-link active" href="/vps/various?setting=firewall&tab=firewall&act=index">
                            ...
                            <a class="nav-link active" href="/vps/contactus?act=index">

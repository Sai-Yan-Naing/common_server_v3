                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading"><a class="text-white" href="/vps/server?tab=connection&act=index" onclick="loading()"><h3><span style="font-size:50px;">W</span>inserver</h3></a></div>

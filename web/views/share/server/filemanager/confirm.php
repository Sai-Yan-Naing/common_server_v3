...
function filepath($dir,$foldername,$webid)
{
    ...
    <tr>
												...
												{ echo $foldername.'/'.$value;}else{echo $value;} ?>" style="cursor: pointer;"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>"  webid="<?=$webid?>">
                                            ...
                                            foreach ($files_list as $key => $value) {
												...
												{ echo 'data-target="#common_dialog"'; } ?> file_name="<?= $value ?>"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>"><div><i class="far fa-file nav-tab-icon"></i><span class="ml-1"><?= $value ?></span></div></td>
                                                ...
                                                <td class="d-flex" colspan="2">
                                                    <div class="col-sm-12 text-end">
                                                        <a href="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>&download=<?=$value?>" class="btn text-dark download_file">

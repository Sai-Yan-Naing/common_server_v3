                        ...
                        ?>
                            ...
                            <div class="tab-content filemanager">
                                ...
                                <tbody id="changebody">
                                    ...
                                    ?>
                                        <tr>
                                        <td class="folder_click" foldername="<?= $value['name'] ?>" style="cursor: pointer;"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>"  webid="<?=$webid?>">
                                            <div class="d-flex">
                                    ...
                                    foreach ($files_list as $key => $value):
                                        ...
                                        <td class="open_file" style="cursor: pointer;" data-toggle="modal" <?php if (in_array($extension, $ext)){ echo 'data-target="#common_dialog"'; } ?> file_name="<?= $value['name'] ?>"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>">
                                        <div class="d-flex">
                                        ...
                                        <td class="d-flex" >
                                            <div class="col-sm-12 ">
                                                ...
                                                <a href="/share/server?setting=filemanager&tab=tab&act=confirm&webid=<?=$webid?>&download=<?=$value['name']?>&common_path=" class="btn download_file">

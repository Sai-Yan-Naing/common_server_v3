                            ...
                            <div id="oyo-setting" class="active pr-3 pl-3 tab-pane">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div id="webconfig_">
                                            <textarea type="text" class="form-control" rows="5" cols="30" readonly><?=  htmlspecialchars(getFile($webpath."/web/web.config"))?>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div id="phpini_">
                                            <textarea type="text" class="form-control" rows="5" cols="30" readonly><?=  htmlspecialchars(getFile($webpath."/web/.user.ini"))?>
                                            </textarea>
                                        </div>
                                    </div>
                                </div>

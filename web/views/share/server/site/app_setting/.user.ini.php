<?php require_once("views/share_config.php"); ?>
    ...
    <button type="button" class="btn btn-outline-info mr-3" form="php_ini_fm" id="php_ini_btn" gourl="/share/server?setting=site&tab=app_setting&act=confirm&apply=.user.ini&webid=<?=$webid?>">保存</button>

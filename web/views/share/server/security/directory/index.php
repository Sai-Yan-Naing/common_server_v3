                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  class="border-dark">
                                                            <a href="javascript:;" class="btn btn-outline-info btn-sm common_dialog" gourl="/share/server?setting=security&tab=directory&act=edit&act_id=<?= $value['id'] ?>&webid=<?=$webid?>"  data-toggle="modal" data-target="#common_dialog">編集</a>
                                                            <a href="javascript:;" class="btn btn-outline-danger btn-sm common_dialog" gourl="/share/server?setting=security&tab=directory&act=delete&act_id=<?= $value['id'] ?>&webid=<?=$webid?>"  data-toggle="modal" data-target="#common_dialog">削除</a>
                                                        </td> 
                                                    </tr>
                                                    <?php
                                                        endforeach;

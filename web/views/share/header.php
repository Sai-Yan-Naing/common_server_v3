...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand" style="height: 75px;">
            <!-- <a class="navbar-brand ps-3" href="/share/server?setting=site&tab=app_install&act=index&webid=<?=$webid?>"><h2><span style="font-size:2em;">W</span>inserver</h2></a> -->
            ...
            <h5 class="text-center font-weight-bold ms-auto text-dark">Winserver Share Control Panel</h5>
            <ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0 me-lg-4">
                <li class="nav-item dropdown">
                    <form action="<?= call_ass() ?>logout" method="post" >
                        <input type="hidden" name="user" value="share_user">

<div class="shadow-lg mb-3 bg-white rounded d-flex font-weight-bold" style="letter-spacing: 3px; font-size:12px">
        ...
        <a href="http://mail.<?=$webdomain?>" target="_blank" class="subtitle pt-4 pb-4 <?=($setting=='database')?"active":"text-dark"?>" onclick="loading()">
            <img src="<?= call_ass() ?>img/subtitle/webmail.png" alt="site.png">
            <br><br>
            <span>WEBメール</span>
        </a>
        <a href="/share/mail?setting=list&tab=null&act=index" class="subtitle pt-4 pb-4 <?=($setting=='list')?"active":"text-dark"?>" onclick="loading()">

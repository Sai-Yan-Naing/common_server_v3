<div class="shadow-lg mb-3 bg-white rounded d-flex font-weight-bold" style="letter-spacing: 3px; font-size:12px">
        ...
        <a href="/share/various?setting=information&act=index" class="subtitle pt-4 pb-4 <?=($setting=='information')?"active":"text-dark"?>">
            <img src="<?= call_ass() ?>img/subtitle/<?=($setting=='information')?"information1":"information"?>.png" alt="site.png">
            <br><br>
            <span>ご契約情報  </span>
        </a>
        <a href="/share/various?setting=backup&act=index" class="subtitle pt-4 pb-4 <?=($setting=='backup')?"active":"text-dark"?>">

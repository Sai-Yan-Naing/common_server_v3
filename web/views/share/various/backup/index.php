                            ...
                            <div class="shadow-lg p-3 mb-5 bg-white rounded">
                                ...
                                <div class="tab-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <form action="/share/various/backup?confirm&webid=<?=$webid?>" method = "post" onsubmit="loading()">
                                                <input type="hidden" name="action" value="auto_backup">
                                                <label class="switch text-white common_dialog" gourl="/share/various?setting=backup&act=onoff&webid=<?=$webid?>"  data-toggle="modal" data-target="#common_dialog">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-5">
                                            <button class="btn btn-outline-info btn-sm common_dialog" gourl="/share/various?setting=backup&act=new&webid=<?=$webid?>"  data-toggle="modal" data-target="#common_dialog"><span class=""><i class="fas fa-plus"></i></span>バックアップを実施</button>
                                        </div>
                                    </div>
                                    <div id="changeBackup">
                                    <?php
                                        ...
                                        <table class="table mt-3 table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-dark">
                                                    <a href="javascript:;" class="btn btn-outline-info btn-sm common_dialog" gourl="/share/various?setting=backup&cron=<?=$getRow['name']?>&act=restore&webid=<?=$webid?>"   data-toggle="modal" data-target="#common_dialog">リストア</a>
                                                    <a href="javascript:;" class="btn btn-outline-danger btn-sm common_dialog" gourl="/share/various?setting=backup&cron=<?=$file?>&act=delete&webid=<?=$webid?>"   data-toggle="modal" data-target="#common_dialog">削除</a>
                                                </td>
                                            </tr>
                                        </table>
                                    <?php 

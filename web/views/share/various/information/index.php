                                    ...
                                    <div class="server-info">
                                        <h6 class="6">サーバー情報</h6>
                                            ...
                                            <div class="form-group d-flex">
                                                ...
                                                <label class="switch text-white common_dialog" gourl="/share/various?setting=information&act=onoff"  data-toggle="modal" data-target="#common_dialog">
                                            ...
                                            <div class="form-group d-flex">
                                                ...
                                                <div class="col-sm-2"><span class="col-form-label"> 起動中 </span></div>
                                                <label class="switch text-white common_dialog" gourl="/share/various?setting=information&act=apponoff"  data-toggle="modal" data-target="#common_dialog">
                                        ...
                                        <!-- <form action="/share/various?confirm" method = "post" id="site-onoff">
                                            <input type="hidden" name="app" value="site">
                                        </form>
                                        <form action="/share/various?confirm" method = "post" id="app-onoff">

...
function open_file($dir,$file_name, $webid)
{
	...
	?>
		...
		<div class="modal-header">
            <button type="button" class="btn btn-outline-info mr-3" id="save_file" file_name="<?= $file_name ?>"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm"  webid="<?=$webid?>">保存</button>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="/share/server?setting=filemanager&tab=tab&act=confirm"   webid="<?=$webid?>" method="post" id="file_editer">
...
function filepath($dir,$foldername,$webid)
{
    ...
    <tr>
												...
												{ echo $foldername.'/'.$value;}else{echo $value;} ?>" style="cursor: pointer;"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm"  webid="<?=$webid?>">
                                            ...
                                            foreach ($files_list as $key => $value) {
												...
												{ echo 'data-target="#common_dialog"'; } ?> file_name="<?= $value ?>"  gourl="/share/server?setting=filemanager&tab=tab&act=confirm"><div><i class="far fa-file nav-tab-icon"></i><span class="ml-1"><?= $value ?></span></div></td>
                                                ...
                                                <td class="d-flex" colspan="2">
                                                    <div class="col-sm-12 text-end">
                                                        <a href="/share/server?setting=filemanager&tab=tab&act=confirm&download=<?=$value?>" class="btn text-dark download_file">

    ...
    <form action="/share/server?setting=database&tab=mysql&act=confirm" method="post" id="database_create">
      <input type="hidden" name="action" value="new">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="db_name" name="db_name" placeholder="8～30文字、半角英数字記号の組み合わせ"  column="db_user" table="db_account" remark="mydbname">
            </div>
        </div>
        <div class="form-group row">
            <label for="db_user" class="col-sm-2 col-form-label">ユーザー名</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="db_user" name="db_user" placeholder="8～30文字、半角英数字記号の組み合わせ"  column="db_user" table="db_account" remark="mydbuser">
            </div>
        </div>
        <div class="form-group row">
